    ...
    <AuthBackground>
      <div className="w-full max-w-md mx-auto animate-slide-up">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/50 mt-1 text-sm">{t('auth.login_subtitle')}</p>
        </div>

        {/* Card */}
        <div className="glass-card rounded-3xl p-8">
          <h2 className="text-xl font-bold text-white mb-6">{t('auth.welcome_back')}</h2>
          ...
          <p className="text-center text-sm text-white/50 mt-6">
            {t('auth.no_account')}{' '}
            <Link href={`/${locale}/register`} className="text-violet-400 hover:text-violet-300 font-medium">
              {t('auth.register')}
            </Link>
          </p>
        </div>
